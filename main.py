    """
    Notification Hub T23q3
    ======================
    Lightweight Flask/FastAPI microservice to aggregate HTTP traffic reliably.
    ...
    APP_NAME    = "Notification Hub T23q3"
    APP_VERSION = "1.0.0"
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight Flask/FastAPI microservice to aggregate HTTP traffic reliably.")
